...
#
#   1, 3/2, 7/5, 17/12, 41/29, 99/70, 239/19, 577/408, 1393/985, 3363/2378, ...
#
...
# Well, this one seems fairly straightforward.
# We just sum up the first part of the infinite fraction, no?


import itertools
from fractions import Fraction

def generate_fraction_terms():
    yield 2;  # a0
...
e_fraction_terms = generate_fraction_terms()

# For a depth of 100, recursion will do.
def sum_continued_fraction(terms: list[int]) -> Fraction:
    assert len(terms) > 0
